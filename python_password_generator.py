...
def generate_password():
  ...
  password_label = Entry(password_generator, bd=0, bg="gray85", textvariable=password_v, state="readonly")
...
password_generator.geometry("350x200")
password_generator.title(" Password Generator")

#Mention the title of the app
title_label = Label(password_generator, text=" Password Generator", font=('Ubuntu Mono',12))
title_label.pack()

#Read length 
length_label = Label(password_generator, text="Enter length of password: ")
length_label.place(x=20,y=30)
length_entry = Entry(password_generator, width=3)
length_entry.place(x=190,y=30)
#Read repetition
repeat_label = Label(password_generator, text="Repetition? 1: no repetition, 2: otherwise: ")
repeat_label.place(x=20,y=60)
repeat_entry = Entry(password_generator, width=3)
repeat_entry.place(x=300,y=60)
#Generate password
password_button = Button(password_generator, text="Generate Password", command=generate_password)
